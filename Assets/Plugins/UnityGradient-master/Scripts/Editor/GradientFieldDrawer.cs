...
namespace Plugins.UnityGradient_master.Scripts.Editor
{
    ...
    public class GradientFieldDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            GUIContent content = new GUIContent(Texture2D.whiteTexture);
        ...
        private void OpenWindow(SerializedProperty property)
        {
        ...
        public static GradientField GenerateGradient(SerializedProperty property, int excludeColor = -1,
            int excludeAlpha = -1)
        {
        ...
        public static Texture2D GenerateInspectorBackground(int tileX, int tileY)
        {
            ...
            for (int x = 0; x < tileX; x++)
            {
                ...
                {
                    texture.SetPixels(x * checkerSize.x, y * checkerSize.y, checkerSize.x, checkerSize.y,
                        checkerPixels);
                }
            }
